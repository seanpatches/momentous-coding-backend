...
const createUser = (req, res) => {
  ...
  const timeCreated = moment().format("dddd, MMMM Do YYYY, h:mm:ss a");
  pool.query('INSERT INTO users (name, email, timeCreated) VALUES ($1, $2, $3) RETURNING *;', [name, email, timeCreated], (error, results) => {
    if(error){
      throw error
    }
